...
/**
 * Purpose : To implement SWAGGER CONFIGURATION for Address system AppApplication.
 *
...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Address Book Service Application")
